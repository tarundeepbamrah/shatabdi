...
public class AdapterDealersinCity extends RecyclerView.Adapter<AdapterDealersinCity.ViewHolder> {
    Context context;
    List<ModelDealers> modelList;
    String sname,date,city,area;

    public AdapterDealersinCity(Context context, List<ModelDealers> modelList, String sname,String date,String city, String area) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.conversation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent j = new Intent(context, ViewConversationloc.class);
